...
public class StartScreen extends JPanel {
    ...
    private final ImageIcon nameImages = new ImageIcon(getClass().getResource("/Images/Cool Text - space NIgga 482251320904050.png"));
    ...
    public StartScreen(int x, int y, int Width, int High) {
        ...
        this.instructionsButton.setBounds((Width / 2) - (startButtonImage.getIconWidth() / 2), (High / 3) - (instructionsButtonImage.getIconHeight() / 2) + (startButtonImage.getIconHeight() / (2) + 10), 300, 70);
        ...
        this.leaderboardButton.setBounds((Width / 2) - (startButtonImage.getIconWidth() / 2), (High / 3) - (leaderboardButtonImage.getIconHeight() / 2) + (instructionsButtonImage.getIconHeight() * (2) / (2) + 10), 300, 70);
